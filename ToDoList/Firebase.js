...
var newProductRef = (0, database_1.ref)(DATABASE, "produtos/item123");
(0, database_1.set)(newProductRef, {
    nome: "Caneta Esferográfica",
    preco: 1.5,
    estoque: 100,
});
(0, database_1.onValue)(newProductRef, function (snapshot) {
    // snapshot é um objeto do firebase, uma representação dos dados no momento em que o evento foi disparado
    var data = snapshot.val();
    console.log(data.estoque, data);
});
