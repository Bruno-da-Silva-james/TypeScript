...
var Player = /** @class */ (function () {
    function Player(canvas, ctx) {
        ...
        this.width = 30; // Define a largura do jogador
        this.height = 10; // Define a altura do jogador
    }
...
var Obstacle = /** @class */ (function () {
    function Obstacle(canvas, ctx) {
        ...
        this.width = 30; // Define a largura do obstáculo
        this.height = 10; // Define a altura do obstáculo
    }
